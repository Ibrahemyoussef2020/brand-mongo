...
export default function CategoriesPage() {
  ...
  // Data State
  const [data, setData] = useState<CategoriesItem[]>([
    { id: '1', name: 'Sample Categories A', status: 'Active', date: 'Oct 24, 2026' },
    { id: '2', name: 'Sample Categories B', status: 'Pending', date: 'Oct 25, 2026' },
    { id: '3', name: 'Sample Categories C', status: 'Inactive', date: 'Oct 26, 2026' },
  ]);
  ...
  const [selectedRecord, setSelectedRecord] = useState<CategoriesItem | null>(null);
  ...
  const handleEditClick = (record: CategoriesItem) => {
    setSelectedRecord(record);
    setFormName(record.name);
    setIsEditModalOpen(true);
  };

  const handleViewClick = (record: CategoriesItem) => {
    setSelectedRecord(record);
    setIsViewModalOpen(true);
  };

  const handleDeleteClick = (record: CategoriesItem) => {
    setSelectedRecord(record);
  ...
  // Table Columns
  const columns: Column<CategoriesItem>[] = [
    { key: 'id', title: 'ID' },
    { key: 'name', title: 'Name' },
    { 
      key: 'status', 
      title: 'Status', 
      render: (record: CategoriesItem) => {
        let color = '#666';
        let bg = '#eee';
  ...
  return (
    <div className="dashboard-page">
      <PageHeader title="Categories" filterText="Last 30 Days" />
      ...
      <DataTable 
        ...
        description="View and manage all your categories here."
        columns={columns} 
        data={data} 
