...
export default function SalesPage() {
  ...
  const [data, setData] = useState<SalesItem[]>([
    { id: '1', name: 'Sample Sales A', status: 'Active', date: 'Oct 24, 2026' },
    { id: '2', name: 'Sample Sales B', status: 'Pending', date: 'Oct 25, 2026' },
    { id: '3', name: 'Sample Sales C', status: 'Inactive', date: 'Oct 26, 2026' },
  ]);
  ...
  const handleViewClick = (record: SalesItem) => {
    setSelectedRecord(record);
    setIsViewModalOpen(true);
  };

  const handleDeleteClick = (record: SalesItem) => {
    setSelectedRecord(record);
  ...
  return (
    <div className="dashboard-page">
      <PageHeader title="Sales" filterText="Last 30 Days" />
      ...
      <DataTable 
        title="Manage Sales" 
        description="View and manage all your sales here."
        columns={columns} 
        data={data} 
