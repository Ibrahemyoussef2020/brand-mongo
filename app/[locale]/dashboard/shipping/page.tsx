...
export default function ShippingDeliveryPage() {
  ...
  const [data, setData] = useState<ShippingDeliveryItem[]>([
    ...
    { id: '2', name: 'Sample Shipping & Delivery B', status: 'Pending', date: 'Oct 25, 2026' },
    { id: '3', name: 'Sample Shipping & Delivery C', status: 'Inactive', date: 'Oct 26, 2026' },
  ]);
  ...
  const handleViewClick = (record: ShippingDeliveryItem) => {
    setSelectedRecord(record);
    setIsViewModalOpen(true);
  };

  const handleDeleteClick = (record: ShippingDeliveryItem) => {
    setSelectedRecord(record);
  ...
  return (
    <div className="dashboard-page">
      <PageHeader title="Shipping & Delivery" filterText="Last 30 Days" />
